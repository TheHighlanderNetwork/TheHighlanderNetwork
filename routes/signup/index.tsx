...
export default function SignUpPage() {
  ...
  const GoogleButton = () => (
    <button className="gsi-material-button block mx-auto" onClick={handleGoogleSignUp}>
      ...
      <div className="font-oswald px-4 py-8 w-screen h-screen bg-grey-light flex flex-col">
        ...
        <div className="flex flex-col justify-center items-center gap-8 mt-8 px-8">
          ...
          <div className="w-full max-w-md p-6 bg-white shadow-md rounded-md">
            <h2 className="text-xl font-bold mb-6 text-center">Student Sign Up</h2>
            <GoogleButton />
          </div>
  
          {/* Business Sign Up */}
          <div className="w-full max-w-md p-6 bg-white shadow-md rounded-md">
            <h2 className="text-xl font-bold mb-6 text-center">Business Sign Up</h2>
